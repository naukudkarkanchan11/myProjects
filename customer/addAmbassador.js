...
router.post('/', function (req, res) {
    trycatch(function (err, data) {
           setTimeout(function () {
                ...
                if (typeof name == undefined || typeof email == undefined || typeof contactNumber == undefined || typeof referral_id == undefined || typeof password == undefined || typeof level == undefined || typeof isAmbassador == undefined) {
                               ...
                               if(err){
                                   ...
                                   if(referral_id === "NONE"){
                                    ...
                                    customers.insert({
                                        ...
                                        "isAmbassador": isAmbassador, //boolean
                                        "payback": 0.0, //double
                                        ...
                                        if (err) {
                                            // console.log("Error" + err);
                                                ...
                                                res.status(res.statusCode).send({
                                                                            "Status": "Ambassador added successfully"
                                                                            });
                                            }
                                    });                                                                           
